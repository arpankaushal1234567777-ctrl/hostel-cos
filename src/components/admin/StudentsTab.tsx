...
import { Users, UserCheck, UserX, Clock, Eye, Check, X, Loader2 } from "lucide-react";
...
export function StudentsTab() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">Students</h1>
